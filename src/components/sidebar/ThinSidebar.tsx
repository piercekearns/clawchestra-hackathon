    ...
    <Tooltip text={label}>
      ...
      >
        ...
        {badgeCount && badgeCount > 0 ? (
          <span className="absolute right-1 top-px inline-flex h-3 min-w-3 items-center justify-center rounded-full bg-[#DFFF00] px-0.5 text-[8px] font-semibold text-neutral-900">
            {badgeCount}
          </span>
        ) : null}
      </button>
