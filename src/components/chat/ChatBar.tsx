  ...
  return (
    <div
      className={`relative flex w-full flex-col ${
        isFloating
          ? `max-h-[50vh] overflow-hidden rounded-xl border border-neutral-300 bg-neutral-0/95 backdrop-blur transition-all dark:border-neutral-600 dark:bg-neutral-900/95 ${
