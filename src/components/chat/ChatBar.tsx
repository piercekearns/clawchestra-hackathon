    ...
    <div
      className={`relative flex w-full flex-col [--input-min:40px] [--input-line:20px] [--input-pad:calc((var(--input-min)-var(--input-line))/2)] [--input-offset:2px] ${
        isFloating
          ...
          : `rounded-xl border border-neutral-300 dark:border-neutral-600 bg-neutral-0 dark:bg-neutral-900 focus-within:ring-1 focus-within:ring-revival-accent-400/40`
