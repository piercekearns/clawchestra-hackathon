...
export function StatusBadge({
  ...
  return (
    <span className="inline-flex flex-none items-center gap-1.5 whitespace-nowrap rounded-full border border-neutral-300 px-2 py-0.5 text-[10px] leading-none text-neutral-700 dark:border-neutral-600 dark:text-neutral-300 overflow-hidden">
