    ...
    case 'plan': {
      if (artifactState.plan === 'present') {
        return [
          ...
          '',
          'Steps:',
          '1. Prefer an embedded coding-agent terminal if one is available. If not, use a generic shell terminal or work directly in the repo from the current environment.',
