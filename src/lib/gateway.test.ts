  ...
  it('ignores synthetic exec-completed user entries as turn boundaries', () => {
    const messages = [
      ...
      { id: 'a-1', role: 'assistant', content: 'step one', timestamp: 11 },
      {
        id: 'u-sys',
        role: 'user',
        content: 'System: [2026-03-03 02:21:14 GMT] Exec completed (young-ro, code 0) :: build output',
        timestamp: 12,
      },
  ...
  it('ignores synthetic exec user entries when status is not "completed"', () => {
    const messages = [
      ...
      { id: 'a-1', role: 'assistant', content: 'step one', timestamp: 11 },
      {
        id: 'u-sys',
        role: 'user',
        content: 'System: [2026-03-03 02:21:14 GMT] Exec failed (agent-x, code 1) :: build output',
        timestamp: 12,
      },
    ...
    const messages = [
      {
        id: 'u-sys',
        role: 'user',
        content: 'System: [2026-03-03 02:21:14 GMT] Exec completed (nova-orb, code 0) :: test output',
        timestamp: 10,
      },
