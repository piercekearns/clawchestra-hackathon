...
- Does this add, change, or remove a user-facing capability or AI surface?

If any answer is YES → update AGENTS.md.
If the last answer is YES → also update `CAPABILITIES.md` (see Hard Rule 5).
