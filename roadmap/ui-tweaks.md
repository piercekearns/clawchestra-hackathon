...
- Move the row **up** so the top of the search field sits where the container’s top edge currently is.
- Add a single thin divider line **below** the row (between the row and the board content).
