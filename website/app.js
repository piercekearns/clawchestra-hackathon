...
const RELEASES_API = 'https://api.github.com/repos/piercekearns/clawchestra/releases';
...
async function loadReleaseSurface() {
  ...
  setElementHref('[data-primary-install]', 'https://github.com/piercekearns/clawchestra/releases');
  setElementHref('[data-release-url]', 'https://github.com/piercekearns/clawchestra/releases');
  setElementHref('[data-release-url-secondary]', 'https://github.com/piercekearns/clawchestra/releases');
