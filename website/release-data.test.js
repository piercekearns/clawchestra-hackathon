...
describe('buildDownloadModel', () => {
  ...
  test('normalizes untagged release urls back to the tag url', () => {
    const model = buildDownloadModel(
      {
        ...
        html_url: 'https://github.com/piercekearns/clawchestra-hackathon/releases/tag/untagged-bf2ec1528cd5531b1693',
        body: '',
        assets: [],
      },
      'unknown',
    ...
    expect(model.releaseUrl).toBe('https://github.com/piercekearns/clawchestra-hackathon/releases/tag/app-v0.1.0-alpha.2');
